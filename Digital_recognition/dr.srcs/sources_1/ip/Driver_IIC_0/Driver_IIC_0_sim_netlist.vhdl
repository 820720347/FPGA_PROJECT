...
-- Date        : Fri Jul 31 16:08:15 2020
-- Host        : LAPTOP-OB780I9N running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               g:/vivadoLab/dr/dr.srcs/sources_1/ip/Driver_IIC_0/Driver_IIC_0_sim_netlist.vhdl
-- Design      : Driver_IIC_0
...
architecture STRUCTURE of Driver_IIC_0_Driver_IIC is
  ...
  signal \scl_cnt[5]_i_2_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \FSM_sequential_c_state[0]_i_2\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \FSM_sequential_c_state[0]_i_3\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \FSM_sequential_c_state[0]_i_6\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \FSM_sequential_c_state[0]_i_7\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \FSM_sequential_c_state[0]_i_8\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \FSM_sequential_c_state[1]_i_3\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \FSM_sequential_c_state[2]_i_2\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \FSM_sequential_c_state[2]_i_3\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \FSM_sequential_c_state[2]_i_4\ : label is "soft_lutpair3";
  ...
  attribute SOFT_HLUTNM of IIC_Busy_INST_0 : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of IIC_Busy_INST_0_i_2 : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of IIC_Busy_INST_0_i_3 : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \IIC_Read_Data[7]_i_3\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \IIC_Read_Data[7]_i_7\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of IIC_SCL_INST_0_i_1 : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of SDA_Dir_i_1 : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of SDA_Dir_i_7 : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of SDA_Dir_i_8 : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of SDA_Dir_i_9 : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \bcnt[0]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \bcnt[2]_i_2\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of iicrd_req_i_1 : label is "soft_lutpair11";
  ...
  attribute SOFT_HLUTNM of \scl_cnt[5]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \scl_cnt[6]_i_1\ : label is "soft_lutpair14";
  ...
  attribute SOFT_HLUTNM of \scl_cnt[9]_i_4\ : label is "soft_lutpair1";
begin
...
\scl_cnt[5]_i_1\: unisim.vcomponents.LUT3
    generic map(
      ...
      I0 => scl_cnt1,
      I1 => scl_cnt(5),
      I2 => \scl_cnt[5]_i_2_n_0\,
      O => \scl_cnt[5]_i_1_n_0\
    );
\scl_cnt[5]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"80000000"
    )
        port map (
      ...
      I3 => scl_cnt(1),
      I4 => scl_cnt(3),
      O => \scl_cnt[5]_i_2_n_0\
    );
\scl_cnt[6]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"28"
    )
        port map (
...
entity Driver_IIC_0 is
  ...
  attribute X_CORE_INFO of Driver_IIC_0 : entity is "Driver_IIC,Vivado 2018.3";
end Driver_IIC_0;
