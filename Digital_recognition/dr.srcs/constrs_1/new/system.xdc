...
create_clock -period 3.7 -name dphy_hs_clock_p -waveform {0.000 1.85} [get_ports Clk_Rx_Data_P];
...
#ret_n
set_property -dict { PACKAGE_PIN N14 IOSTANDARD LVCMOS33 } [ get_ports rst_n ];

#SEG7
set_property -dict { PACKAGE_PIN J1 IOSTANDARD LVCMOS33 } [ get_ports seg[7] ];
set_property -dict { PACKAGE_PIN M14 IOSTANDARD LVCMOS33 } [ get_ports seg[6] ];
set_property -dict { PACKAGE_PIN C4 IOSTANDARD LVCMOS33 } [ get_ports seg[5] ];
set_property -dict { PACKAGE_PIN B13 IOSTANDARD LVCMOS33 } [ get_ports seg[4] ];
set_property -dict { PACKAGE_PIN N10 IOSTANDARD LVCMOS33 } [ get_ports seg[3] ];
set_property -dict { PACKAGE_PIN M10 IOSTANDARD LVCMOS33 } [ get_ports seg[2] ];
set_property -dict { PACKAGE_PIN B14 IOSTANDARD LVCMOS33 } [ get_ports seg[1] ];
