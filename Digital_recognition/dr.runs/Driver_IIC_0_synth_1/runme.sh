...
HD_PWD='G:/vivadoLab/dr/dr.runs/Driver_IIC_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Driver_IIC_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Driver_IIC_0.tcl
