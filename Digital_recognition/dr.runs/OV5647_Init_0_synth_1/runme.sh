...
HD_PWD='G:/vivadoLab/dr/dr.runs/OV5647_Init_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log OV5647_Init_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source OV5647_Init_0.tcl
