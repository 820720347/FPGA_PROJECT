...
#
# Generated by export_simulation on Fri Jul 31 16:07:40 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './Driver_IIC_0.sh' script.

./Driver_IIC_0.sh -reset_run
...
./Driver_IIC_0.sh -noclean_files

For more information on the script, please type './Driver_IIC_0.sh -help'.
