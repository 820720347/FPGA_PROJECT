...
HD_PWD='G:/vivadoLab/Shape_Judge/Shape_Judge.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_geometric_figure_cen_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_geometric_figure_cen_0_1.tcl
