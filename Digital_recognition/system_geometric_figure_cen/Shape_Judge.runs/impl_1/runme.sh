...
HD_PWD='G:/vivadoLab/Shape_Judge/Shape_Judge.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log system_geometric_figure_cen_0_1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source system_geometric_figure_cen_0_1.tcl -notrace
